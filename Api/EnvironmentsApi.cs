...
namespace LaunchDarkly.Api.Api
{
    ...
    public interface IEnvironmentsApi
    {
        ...
        Model.Environment GetEnvironment (string projectKey, string environmentKey);
        /// <summary>
        ...
        /// <returns>Environment</returns>
        Model.Environment PatchEnvironment (string projectKey, string environmentKey, List<PatchOperation> patchDelta);
        /// <summary>
        ...
        /// <returns>Environment</returns>
        Model.Environment PostEnvironment (string projectKey, EnvironmentPost environmentBody);
    }
...
path = path.Replace("{" + "environmentKey" + "}", ApiClient.ParameterToString(environmentKey));
        ...
        /// <param name="environmentKey">The environment key, used to tie together flag configuration and users under one environment so they can be managed together.</param> 
        /// <returns>Environment</returns>            
        public Model.Environment GetEnvironment (string projectKey, string environmentKey)
        {
...
path = path.Replace("{" + "environmentKey" + "}", ApiClient.ParameterToString(environmentKey));
            ...
            return (Model.Environment) ApiClient.Deserialize(response.Content, typeof(Model.Environment), response.Headers);
        }
        ...
        /// <param name="patchDelta">Requires a JSON Patch representation of the desired changes to the project. &#39;http://jsonpatch.com/&#39;</param> 
        /// <returns>Environment</returns>            
        public Model.Environment PatchEnvironment (string projectKey, string environmentKey, List<PatchOperation> patchDelta)
        {
...
path = path.Replace("{" + "environmentKey" + "}", ApiClient.ParameterToString(environmentKey));
        ...
        /// <param name="environmentBody">New environment.</param> 
        /// <returns>Environment</returns>            
        public Model.Environment PostEnvironment (string projectKey, EnvironmentPost environmentBody)
        {
